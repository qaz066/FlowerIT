...
Original file is located at
    https://colab.research.google.com/drive/1EqHvV3l1kutKA2hBjZyjseehiufWSKRx
"""
...
model.save('/content/drive/MyDrive/TS/ResNet50.keras')

converter = tf.lite.TFLiteConverter.from_keras_model(model)
converter.optimizations = [tf.lite.Optimize.DEFAULT]   # 동적범위 양자화
tflite = converter.convert()
with open(os.path.join(SAVE_DIR, "ResNet50.tflite"), "wb") as f:
    f.write(tflite)
